        ...
        <div class="bjui-searchBar">
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <li><a href="<%=request.getContextPath()%>/user/add.do" data-toggle="dialog" data-width="1000" data-height="600" data-id="dialog-mask" data-mask="true"><i class="fa fa-plus"></i> 新增数据</a></li>
                    </ul>
                </div>
            </div>
        </div>
