...
<div class="bjui-pageContent">
    <form action="<%=request.getContextPath()%>/cp/update.do" data-toggle="validate" data-reload-navtab="true">
                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="text" name="cpname" value="${info.cpname}" size="60">
                        </td>
                    </tr>
                      <tr>
                        <td colspan="2">
                            <label class="control-label x100">菜谱类型：</label>
                            <input type="text" name="cplx" value="${info.cplx}" size="60">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
