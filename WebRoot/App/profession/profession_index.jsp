...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.lang.*,java.util.*,app.home.model.Profession"%>
...
<div class="bjui-pageContent">
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
    	...
    	<tbody>
    <% Profession pro=(Profession)request.getAttribute("list");%>
    <tr>
    <td><%=pro.getName() %></td>
    <td><%=pro.getCounselor()%></td>
    <td><%=pro.getPnum() %></td>
    <td>
    			<a href="<%=request.getContextPath()%>/cp/edit.do?id=${list.id}" class="btn btn-default" data-toggle="dialog" data-width="1000" data-height="600" data-id="dialog-mask" data-mask="true">编辑</a>
    			<a href="<%=request.getContextPath()%>/cp/delete.do?id=${list.id}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除吗？">删除</a>
